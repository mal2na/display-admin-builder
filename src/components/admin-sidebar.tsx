...
import { MonitorSmartphone, LayoutGrid, Ticket, MessageSquareText, PackagePlus } from 'lucide-react';
  ...
  return (
    <aside className={cn('flex shrink-0 flex-col bg-[#ebeef6] transition-[width] duration-200', collapsed ? 'w-14' : 'w-56')}>
      <nav className="flex flex-1 flex-col gap-1 p-2 pt-3">
        ...
        <NavLink href="/admin/products/new" icon={<PackagePlus className="h-4 w-4" />} label="전시 상품 관리" collapsed={collapsed} />
